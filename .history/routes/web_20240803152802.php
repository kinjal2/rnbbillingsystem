...
//03-08-2024
Route::get('/namechangerequest', [NewConnectionController::class, 'NameChangeRequest'])->name('namechangerequest');
Route::Post('/serchcustomerno', [NewConnectionController::class, 'SerchCustomerNo'])->name('serchcustomerno');
