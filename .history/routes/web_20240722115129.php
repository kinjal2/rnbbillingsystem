...
Route::get('/', function () {
    return view('welcome');
});//->middleware(GlobalErrorHandling::class);
...
Route::post('/getcustomerlist', [NewConnectionController::class, 'getcustomerlist'])->name('getcustomerlist');
...
Route::get('/citizendetails', [CitizenController::class, 'citizenDetails'])->name('citizendetails');
Route::get('/bill/{cust_no}', [CitizenController::class, 'showDetails'])->name('bill.show');
