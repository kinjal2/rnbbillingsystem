...
class CTPBillCollectionController extends Controller
{
    ...
    public function paymentHandshake($data)
    {
		...
		$formHtml .= '<input type="hidden" name="Dept_call" value="second">';
		$formHtml .= '<input type="hidden" name="token_valid" value="true">';
		$formHtml .= '<input type="hidden" name="Transaction_id" value="' . $transactionId . '">';
		$formHtml .= '<input type="hidden" name="User_id" value="1">';
		$formHtml .= '</form>';
		$formHtml .= '<script type="text/javascript">';
