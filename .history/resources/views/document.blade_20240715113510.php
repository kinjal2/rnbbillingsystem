        ...
        <div class="row">
            <div style="float: left; width: 60%;">
                <table>
                    ...
                    <tr><td>Customer No: {{ $cust_no }}</td></tr>
                    <tr><td>Name: {{ $cust_name }}</td></tr>
                    <tr><td>Sector: {{ $sector_no }}</td></tr>
                    <tr><td>Plot No: {{ $plot_no }}</td></tr>
                    <tr><td>Cheque No: {{ $cheque_no }}</td></tr>
                    <tr><td>Date: {{ $created_at }}</td></tr>
                    <tr><td>Bank: {{ $bank_name }}</td></tr>
                    <tr><td>Branch: {{ $branch_name }}</td></tr>
                    <tr><td>Total Amount Rs.: {{ $amount }}</td></tr>
                    <tr><td>Rupees in Words: {{ $amountword }}</td></tr>
