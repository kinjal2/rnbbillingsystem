				...
				<div class="card-body">
					...
					<form method="POST" action="{{ url('savenewconnection') }}"  name="newconnection" id="newconnection" enctype="multipart/form-data"> 
								...
								<div class="form-row">
									...
									<div class="form-row">
                                        <div class="form-group col-md-12">
                                            <label for="inputEmail4">New Applicant's Name</label>
                                            <input type="text" class="form-control"  name='applicant_name_new' id="applicant_name_new" placeholder="Applicant Name">
                                        </div>
                                    </div>	
                                <div class="form-row">
...
$('#ajaxForm').submit(function(e) {
	...
	({
		...
		success: function(response) {
			...
			$('#sector_no').val(data.sector_no).trigger('change');
		},
