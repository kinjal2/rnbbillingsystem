...
<head>
    ...
    <style>
        ...
        footer { display: block; bottom: 0px; left: 0; width: 100%; padding-top: 50px; }
...
<body>
    <table class="text-center" cellspacing="0" cellpadding="0" style="width:100%;">
        ...
        <tr>
            <td class="text-blue padd_top10 border-bottom" colspan="2"><h2>Challan of Cash paid the State Bank of India, Gandhinagar</h2></td>
        </tr>
    </table>
        ...
        <tr>
            <td>
                <table class="padd-3" cellspacing="0" cellpadding="0" style="width:100%;">
                    <tr><td>To be filled by the Remitter</td></tr>
                    ...
                    <tr><td class="padd_top5">Deputy Executive Engineer,</td></tr>
                    <tr><td class="padd_top5">Capital Project Sub Division-9, Gandhinagar. Phone: 23259166</td></tr>
                </table>
            </td>
        </tr>
        <tr>
            <td>
                <table class="padd-3 border-tbl_bdr_td mt-25" cellspacing="0" cellpadding="0" style="width: 90%;">
                    <tr class="bg-dark">
                        <th class="text-left">Full Particulars of the remittance & the authority (if any)</th>
                        <th>Amount</th>
                    </tr>
                    <tr>
                        <td>P.W. Remittance by <br> Cheque/D.D Details as over leaf <br><span class="cash-block">Cash Details</span></td>
                        <td></td>
                    </tr>
                    <tr>
                        <td class="text-center"><span class="padd_eql_lr">2000</span><span class="padd_eql_lr">X</span><span class="padd_eql_lr">45</span><span class="padd_eql_lr">=</span></td>
                    ...
                    <tr>
                        <td class="bold text-center">Total Rs.</td>
                        <td class="bold text-right">676457657</td>
                    </tr>
                    <tr>
                        <td colspan="2">Rupees in Words</td>
                    </tr>
                    <tr>
                        <td colspan="2" class="text-capitalize bg-light1"><b>Rupees one hundred twenty-three thousand four hundred forty-five</b></td>
                    </tr>
                    <tr>
                        <td><span>For water/Drainage Charges Year Deposit</span></td>
                        <td><span>2023-24 <br> R. & R.</span></td>
                    </tr>
                </table>
            </td>
        </tr>
    ...
    <table cellspacing="0" cellpadding="0" style="width:50%; padding-left: 10px;" class="font-13 text-b mt-25">
        <tr><td colspan="2">To be filled up by the departmental officer of the Treasury</td></tr>
        <tr><td>Head of Account:</td><td><b>8754 Cash Remittance</b></td></tr>
        <tr><td>Remittance:</td><td>P.W. Remittance <br>1<sup>st</sup> Payment into Try <br> on The A/C. the Ex. Engr<br> C.P. Dn-No.3, Gandhinagar</td></tr>
        ...
        <tr><td colspan="2" class="bold padd_top50">Deputy Executive Engineer<br> Capital Project Sub Division-9 <br> Gandhinagar</td></tr>
    ...
    <table cellspacing="0" cellpadding="0" style="width: 100%; padding-left: 10px;" class="font-13 text-b mt-25">
        <tr><td colspan="3" class="bold padd_top25">Deputy Executive Engineer<br> Capital Project Sub Division-9 <br> Gandhinagar</td></tr>
        <tr><td colspan="3" class="padd_top25">Received Payment</td></tr>
        <tr>
            <td class="padd_top25">Treasury</td>
