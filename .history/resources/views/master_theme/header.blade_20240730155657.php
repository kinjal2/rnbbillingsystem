    ...
    <nav class="main-menu clearfix" id="main_menu">
     ...
     <li class="home" ><a  href="{{ route('citizenlogin') }}"><b>Citizen login &nbsp;<i class="fa fa-sign-in"></i></b></a></li>
      ...
      @if(Auth::check())
                <!-- User is logged in -->
                <li class="home">
                    <a href="https://staging5.gujarat.gov.in/SSOtest/SSO.aspx?Rurl={{ route('departmentlogin') }}">
                        <b> LOG IN &nbsp;<i class="fa fa-sign-in"></i></b>
                    </a>
                </li>
                <li class="home">
                    <a href="{{ route('citizenlogin') }}">
                        <b>Citizen login &nbsp;<i class="fa fa-sign-in"></i></b>
                    </a>
                </li>
                <li class="home">
                    <a href="{{ route('logout') }}">
                        <b>Logout &nbsp;<i class="fa fa-sign-out"></i></b>
                    </a>
                </li>
            @else
                ...
                <li class="home">
                    <a href="{{ route('register') }}">
                        <b>Register &nbsp;<i class="fa fa-user-plus"></i></b>
                    </a>
                </li>
            @endif
     </ul>
