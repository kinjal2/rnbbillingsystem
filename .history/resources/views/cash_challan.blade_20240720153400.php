...
<table class=" mt-25" cellspacing="0" cellpadding="0" style="width:50%; float: left;">
  ...
  <tr><td>
    <table class="padd-3 border-tbl_bdr_td mt-25" cellspacing="0" colspacing="0" style="width: 90%;">
      <tbody> 
        <tr class= "bg-dark">
          <th class="text-left">Full Particulars of the remittance & the authotity (if any)</th>
          <th>Amount</th>
        </tr> 
        <tr>
          <td>P.W. Remittance by <br> Cheque/D.D  Details as over leaf <br><span class="cash-block">Cash Details</span>
          </td>
          <td></td>
        </tr>
        <tr>
