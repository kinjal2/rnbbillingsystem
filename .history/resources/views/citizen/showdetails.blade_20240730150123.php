      ...
      <table class="rwd-table">
        <tbody>
         ...
         <!--   <th>Payment </th>-->
          ...
          <tr>
          <td data-th="Sl. No." colspan='3'  style="text-align: center;"> <a class="btn btn-danger" href="#openModal-make-payment">Make Payment</a></td>
</tr>       
        </tbody>
      </table>
    </div>
  ...
  <div>
         ...
         <div class="white_card_body">
          ...
          <div class="form-row bank" >
            ...
            <label class="font-15">I/We agree and accept all the terms and conditions mention above and I/We hereby certify that no online chargeback claim will be made in this regards.
              <br><span style="padding-left:10px;">Please check all details before clicking on confirm button</span>
            </label>				
          </div>
          <div class="form-group mt-20">
            <button type="submit" id="btnSubmit" name="btnSubmit" class="btn_primary">Confirm</button>
            <button type="button" class="btn_primary-1 mx-5">Cancle</button>
          </div>          
				</div>
