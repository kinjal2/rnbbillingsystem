  ...
  <div>
        ...
        <h2>Charge Back Policy</h2>
          ...
          <li>“This transaction is payment towards Government dues, fees hence would not be covered under chargeback policy.”</li>
				...
				<label>I/We agree and accept all the terms and conditions mention above and I/We hereby certify that no online chargeback claim will be made in this regards.
          ...
          <button type="button" class="btn btn-warning mr-1">Cancle</button>
				</div>
				</div>
