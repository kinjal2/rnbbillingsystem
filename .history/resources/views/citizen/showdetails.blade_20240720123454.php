...
<div class="tabs"><a id="t2"></a><a href="#t2">Receipt</a><div>
...
<div>
		<a id="t1"></a><a href="#t1">Make Payment</a><div>
...
<div id="openModal-make-payment" class="modalDialog" style="height: 100vh; overflow-y:scroll;">
         <a href="#close" title="Close" class="close">X</a>
        <ul class="vesell-view press mt-4">
          <li class="admin-basic-list px-3">
            <div class="row">
